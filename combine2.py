...
class KeyFrameControlNode1(Node):
...
def main():
    ...
    """
    dim = 3
    sun_translate_keys = {5*i : -1 * dim * vec(math.cos(math.radians(i*10)) ,  3.2 * math.sin(math.radians(-i*10))+.6 ) for i in range(0,17)}
    sun_rotate_keys = {0: quaternion(), 2: quaternion(), 3: quaternion(), 4: quaternion()}
    sun_scale_keys = {0: .1}
    sun_keynode = KeyFrameControlNode(sun_translate_keys, sun_rotate_keys, sun_scale_keys, True)
